...
const Modal: React.FC<ModalProps> = ({ id, onCancel, onClose, onOk }) => {
  ...
  return (
    <div className={state.modalClass} tabIndex={-1}>
      <div className="modal-dialog modal-xl">
        <div className="modal-content">
          ...
          <div className="modal-footer">
            ...
            <button type="button" className="btn btn-primary" onClick={onOkBtn}>
              Save changes
            </button>
          </div>
        </div>
